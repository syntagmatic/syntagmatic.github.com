function hypercube() {
  window.HYPERCUBE_DEFAULT_OPTIONS = window.HYPERCUBE_DEFAULT_OPTIONS || { 'edges': true, 'indices': true, 'perspective': true, 'rotate_zw': true, 'rotate_yw': true, 'rotate_xz': true};
